...
public class TablaSimbolos {
    ...
    /**
     * Registra un valor constante para constant propagation
     */
    public void registerConstant(String identifier, Expression value) {
        constantValues.put(identifier, value);
    }
    
    /**
     * Obtiene el valor constante de una variable si existe
     */
    public Expression getConstantValue(String identifier) {
        return constantValues.get(identifier);
    }
    
    /**
     * Valida tipos en expresiones aritméticas
     * @return true si los tipos son compatibles
     */
    public boolean validateArithmeticTypes(Expression left, Expression right) {
        // Validación básica para enteros
        if (left.getTipo() == TipoDato.INT && right.getTipo() == TipoDato.INT) {
            return true;
        }
...
public boolean existeFuncion(String identificador) {
     ...
     */
    public Variable getVariable(String nombreVariable, String ambito){
